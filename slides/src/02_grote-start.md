...
![](assets/01_kleine-start/scrum.png) <!-- .element: style="max-width: 100%; max-height: 100% -->
...
![](assets/02_grote-start/trello.png) <!-- .element: style="max-width: 100%; max-height: 100% -->
...
<div style="display: grid; grid-template-columns: 1fr 1fr; text-align: left;">
<div>
